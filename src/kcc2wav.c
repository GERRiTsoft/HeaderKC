...
//4800HZ from 48K
int samples[]={7000,12000}; //a cheated high pass
...
int load(const char *kcc)
{
    ...
    dataLen=len;
    printf("Länge inklusive Header ist %d Bytes, ohne %d(0x%04x) Bytes.\n",(unsigned int)len,(unsigned int)(len-128),(unsigned int)(len-128));
    fclose(in);
    return 0;
}
...
int main(int argc, char **argv)
{
    ...
    printf("PCM Daten erzeugen...\n");
    createData(count);
    printf("PCM Daten schreiben...\n");
